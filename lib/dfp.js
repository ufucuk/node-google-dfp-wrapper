 ...
 */
function _makeQuery(conditions, fields, log) {
  // if (log) {
  //   console.log('----- _makeQuery --------')
...
Dfp.prototype.updateLineItems = function(lineItems) {
  ...
  return this.dfpUser.executeAPIFunction('LineItemService', 'updateLineItems', input );
};
...
Dfp.prototype.updateCreatives = function(creatives) {
  ...
  return this.dfpUser.executeAPIFunction('CreativeService', 'updateCreatives', input );
};
...
function extractResults(response) {
  if (!response.results) {
    ...
    // console.log(response.results[1].creativePlaceholders);
...
//    // criteriaKeyStore.getAsync(name)
//    //  .bind(this)
//    //  .catch(function() {
...
//       var j = this.getCriteriaKey(conditions);
//       console.log('xxxxxxxxxxxxxxxx XXXXXXXX');
//       console.log(j);
//       return j;
...
Dfp.prototype.getCriteriaValue = function(conditions) {
  ...
  var query = _makeQuery(conditions, CRITERIA_VALUE_FIELDS, true);
  // console.log('getCriteriaValue - query')
  // console.log(query)
  return this.dfpUser.executeAPIFunction(service, method, query)
    .then(extractResults)
    .then(extractFirstId);
...
Dfp.prototype.lookupCriteriaValues = function(value, keyId) {
  ...
  // console.log(value)
  // console.log(keyId)
  var conditions = {name: value, customTargetingKeyId: keyId};

  return this.getCriteriaValue(conditions) .then(function(id) {
    // console.log('lookupCriteriaValues - id')
    // console.log(id)
    return [id];
  });
...
Dfp.prototype.replaceOrderName = function(_lineItem) {
  ...
  var conditions = {name: lineItem.orderName };
...
Dfp.prototype.createLineItems = function(lineItems) {
  ...
  // console.log('XXXXXX XXXXXXXXX xXXXXXXXXXX xXXXXXXXXXXX xXXXXXXXXXXXX XXXXXXXXXXXx')
  // console.log(lineItems)
  return this.dfpUser.executeAPIFunction(service, method, input);
};
...
Dfp.prototype.getAdvertiser = function(conditions) {
  ...
  // console.log('running getAdvertiser')
  return this.dfpUser.executeAPIFunction(service, method, query)
    .then(extractResults)
    .then(extractFirstId);
};
...
Dfp.prototype.replacePartnerName = function(_item) {
  ...
  return this.getAdvertiser(conditions)
    .then(function(advertiserId) {
      ...
      console.log('the advertiser ID is: '+advertiserId);
      delete item.partner;
      console.log('----------------- the prepared order');
      console.log(item)
      console.log('................................. ok');
      return item;
    });
